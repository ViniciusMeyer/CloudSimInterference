...
public class IntContainerVmPe {
     ...
     * The pe provisioner.
     */
    private IntContainerVmPeProvisioner containerVmPeProvisioner;
     ...
     * @post $none
     */
    public IntContainerVmPe(int id, IntContainerVmPeProvisioner containerVmPeProvisioner) {
        setId(id);
    ...
    public IntContainerVmPeProvisioner getContainerVmPeProvisioner() {
     ...
     */
    public void setContainerVmPeProvisioner(IntContainerVmPeProvisioner containerVmPeProvisioner) {
