...
public class IntContainerPeList {
	 ...
	 * @post $none
	 */
	public static <T extends IntContainerPe> IntContainerPe getById(List<T> peList, int id) {
		for (IntContainerPe pe : peList) {
			if (pe.getId() == id) {
				return pe;
			}
		}
	 ...
	 * @post $none
	 */
	public static <T extends IntContainerPe> int getMips(List<T> peList, int id) {
		IntContainerPe pe = getById(peList, id);
		if (pe != null) {
			return pe.getMips();
		}
		return -1;
	 ...
	 * @post $none
	 */
	public static <T extends IntContainerPe> int getTotalMips(List<T> peList) {
		int totalMips = 0;
		for (IntContainerPe pe : peList) {
	 ...
	 */
	public static <T extends IntContainerPe> double getMaxUtilization(List<T> peList) {
	 ...
	 * @return the utilization
	 */
	public static <T extends IntContainerPe> double getMaxUtilizationAmongVmsPes(List<T> peList, IntContainer container) {
		double maxUtilization = 0;
		for (IntContainerPe pe : peList) {
	 ...
	 * @post $none
	 */
	public static <T extends IntContainerPe> IntContainerPe getFreePe(List<T> peList) {
		for (IntContainerPe pe : peList) {
	 ...
	 * @post $result >= 0
	 */
	public static <T extends IntContainerPe> int getNumberOfFreePes(List<T> peList) {
		int cnt = 0;
		for (IntContainerPe pe : peList) {
			if (pe.getStatus() == IntContainerPe.FREE) {
				cnt++;
			}
		}
		return cnt;
	 ...
	 * @post $none
	 */
	public static <T extends IntContainerPe> boolean setPeStatus(List<T> peList, int id, int status) {
		IntContainerPe pe = getById(peList, id);
		if (pe != null) {
			pe.setStatus(status);
			return true;
	 ...
	 * @post $result >= 0
	 */
	public static <T extends IntContainerPe> int getNumberOfBusyPes(List<T> peList) {
		int cnt = 0;
		for (IntContainerPe pe : peList) {
	 ...
	 * <tt>machineID</tt> are used for debugging purposes, which is <b>ON</b> by
	 * default. Use
	 *
	 *
	 ...
	 */
	public static <T extends IntContainerPe> void setStatusFailed(List<T> peList, String resName, int hostId,
			boolean failed) {
		String status = null;
		if (failed) {
			status = "FAILED";
	...
	/**
	     ...
	     * @param peList the pe list
	     */
	    public static <T extends IntContainerPe> void setStatusFailed(List<T> peList, boolean failed) {
