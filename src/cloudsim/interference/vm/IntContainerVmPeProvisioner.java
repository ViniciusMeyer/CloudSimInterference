...
public abstract class IntContainerVmPeProvisioner{
 ...
 * @post $none
 */
public IntContainerVmPeProvisioner(double mips) {
 ...
 * @post $none
 */
public abstract boolean allocateMipsForContainerVm(IntContainerVm containerVm, double mips);
 ...
 * @post $none
 */
public abstract boolean allocateMipsForContainerVm(IntContainerVm containerVm, List<Double> mips);
 ...
 * @post $none
 */
public abstract List<Double> getAllocatedMipsForContainerVm(IntContainerVm containerVm);
 ...
 * @post $none
 */
public abstract double getTotalAllocatedMipsForContainerVm(IntContainerVm containerVm);
 ...
 * @post $none
 */
public abstract double getAllocatedMipsForContainerVmByVirtualPeId(IntContainerVm containerVm, int peId);
 ...
 * @post none
 */
public abstract void deallocateMipsForContainerVm(IntContainerVm containerVm);
