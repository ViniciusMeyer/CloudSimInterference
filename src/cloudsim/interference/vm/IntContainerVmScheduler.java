...
public abstract class IntContainerVmScheduler {
     ...
     */
    private Map<String, List<IntContainerVmPe>> peMap;
     ...
     * @post $none
     */
    public IntContainerVmScheduler(List<? extends IntContainerVmPe> pelist) {
        setPeList(pelist);
        setPeMap(new HashMap<String, List<IntContainerVmPe>>());
        setMipsMap(new HashMap<String, List<Double>>());
        setAvailableMips(IntContainerVmPeList.getTotalMips(getPeList()));
     ...
     * @post $none
     */
    public abstract boolean allocatePesForVm(IntContainerVm vm, List<Double> mipsShare);
     ...
     * @post $none
     */
    public abstract void deallocatePesForVm(IntContainerVm vm);
    ...
    public void deallocatePesForAllContainerVms() {
        getMipsMap().clear();
        setAvailableMips(IntContainerVmPeList.getTotalMips(getPeList()));
        for (IntContainerVmPe pe : getPeList()) {
     ...
     */
    public List<IntContainerVmPe> getPesAllocatedForContainerVM(IntContainerVm vm) {
     ...
     * @post $none
     */
    public List<Double> getAllocatedMipsForContainerVm(IntContainerVm vm) {
     ...
     */
    public double getTotalAllocatedMipsForContainerVm(IntContainerVm vm) {
        double allocated = 0;
     ...
     */
    protected <T extends IntContainerVmPe> void setPeList(List<T> peList) {
        this.peList = peList;
    }
     ...
     * @return the pe map
     */
    public Map<String, List<IntContainerVmPe>> getPeMap() {
        return peMap;
    }
     ...
     */
    protected void setPeMap(Map<String, List<IntContainerVmPe>> peMap) {
        this.peMap = peMap;
    }
