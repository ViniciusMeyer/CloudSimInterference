...
public abstract class IntContainerPeProvisioner {
	/** The mips. */
	private double mips;
	 ...
	 * @post $none
	 */
	public IntContainerPeProvisioner(double mips) {
	 ...
	 * @post $none
	 */
	public abstract boolean allocateMipsForContainer(IntContainer container, double mips);
	 ...
	 * @post $none
	 */
	public abstract boolean allocateMipsForContainer(IntContainer container, List<Double> mips);
	 ...
	 * @post $none
	 */
	public abstract List<Double> getAllocatedMipsForContainer(IntContainer container);
	 ...
	 * @post $none
	 */
	public abstract double getTotalAllocatedMipsForContainer(IntContainer container);
	 ...
	 * @post $none
	 */
	public abstract double getAllocatedMipsForContainerByVirtualPeId(IntContainer container, int peId);
	 ...
	 * @post none
	 */
	public abstract void deallocateMipsForContainer(IntContainer container);
