...
import cloudsim.interference.list.IntContainerVmPeList;

public class IntContainerDataCenterCharacteristics {
	 ...
	 * The host list.
	 */
	private List<? extends IntContainerHost> hostList;
     ...
     * @post $none
     */
    public IntContainerDataCenterCharacteristics( String architecture, String os,String vmm, List<? extends IntContainerHost> hostList, double timeZone, double costPerSec, double costPerMem,  double costPerStorage, double costPerBw){
        setId(-1);
	 ...
	 * @post $none
	 */
	public IntContainerHost getHostWithFreePe() {
		return IntContainerHostList.getHostWithFreePe(getHostList());
	}
	 ...
	 * @post $none
	 */
	public IntContainerHost getHostWithFreePe(int peNumber) {
		return IntContainerHostList.getHostWithFreePe(getHostList(), peNumber);
	}
	...
	public int getMipsOfOnePe() {
		...
		return IntContainerVmPeList.getMips(getHostList().get(0).getPeList(), 0);
	}
	...
	public int getMipsOfOnePe(int id, int peId) {
		...
		return IntContainerVmPeList.getMips(IntContainerHostList.getById(getHostList(), id).getPeList(), peId);
	}
	...
	public int getMips() {
		...
		case IntContainerDataCenterCharacteristics.TIME_SHARED:
		case IntContainerDataCenterCharacteristics.OTHER_POLICY_SAME_RATING:
			mips = getMipsOfOnePe() * IntContainerHostList.getNumberOfPes(getHostList());
			break;

		// Assuming all PEs in a given Machine have the same rating.
		// But different machines in a Cluster can have different rating
		case IntContainerDataCenterCharacteristics.SPACE_SHARED:
		case IntContainerDataCenterCharacteristics.OTHER_POLICY_DIFFERENT_RATING:
			for (IntContainerHost host : getHostList()) {
	...
	public int getNumberOfPes() {
		return IntContainerHostList.getNumberOfPes(getHostList());
	}
	...
	public int getNumberOfFreePes() {
		return IntContainerHostList.getNumberOfFreePes(getHostList());
	}
	...
	public int getNumberOfBusyPes() {
		return IntContainerHostList.getNumberOfBusyPes(getHostList());
	}
	...
	public boolean setPeStatus(int status, int hostId, int peId) {
		return IntContainerHostList.setPeStatus(getHostList(), status, hostId, peId);
	}
	 ...
	 */
	protected <T extends IntContainerHost> void setHostList(List<T> hostList) {
