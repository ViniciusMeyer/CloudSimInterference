...
public class Solution_v1 implements Cloneable {
	...
	public Solution_v1 copy() {
		Solution_v1 copy = new Solution_v1();
		for (int i = 1; i <= this.placement.size(); i++) {
	...
	public int getNumberOfMigrations(Solution_v1 solutionAux) {
		int cont =0;
