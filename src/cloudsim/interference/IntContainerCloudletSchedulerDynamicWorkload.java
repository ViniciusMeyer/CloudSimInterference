...
public class IntContainerCloudletSchedulerDynamicWorkload extends IntContainerCloudletSchedulerTimeShared {
         ...
         */
        public IntContainerCloudletSchedulerDynamicWorkload (double mips, int numberOfPes) {
            super();
            setMips(mips);
        ...
        public double updateContainerProcessing(double currentTime, List<Double> mipsShare) {
            ...
            for (ResCloudlet rcl : getCloudletExecList()) {
                rcl.updateCloudletFinishedSoFar((long) (timeSpan * getTotalCurrentAllocatedMipsForCloudlet(rcl, getPreviousTime()) * Consts.MILLION));
        ...
        public double cloudletSubmit(Cloudlet cl, double fileTransferTime) {
            ...
            //Log.printLine("ESTIMATED TIME          =                   "+ getEstimatedFinishTime(rcl, getPreviousTime()));
