...
public abstract class IntContainerScheduler{
	
	 /** The peList. */
    private List<? extends IntContainerPe> peList;

    /** The map of VMs to PEs. */
    private Map<String, List<IntContainerPe>> peMap;
     ...
     * @post $none
     */
    public IntContainerScheduler(List<? extends IntContainerPe> pelist) {
        setPeList(pelist);
        setPeMap(new HashMap<String, List<IntContainerPe>>());
        setMipsMap(new HashMap<String, List<Double>>());
        setAvailableMips(IntContainerPeList.getTotalMips(getPeList()));
     ...
     * @post $none
     */
    public abstract boolean allocatePesForContainer(IntContainer container, List<Double> mipsShare);
     ...
     * @post $none
     */
    public abstract void deallocatePesForContainer(IntContainer container);
    ...
    public void deallocatePesForAllContainers() {
        getMipsMap().clear();
        setAvailableMips(IntContainerPeList.getTotalMips(getPeList()));
        for (IntContainerPe pe : getPeList()) {
     ...
     */
    public List<IntContainerPe> getPesAllocatedForVM(IntContainer container) {
...
//        Log.printConcatLine("The available Mips is ", availableMips);
     ...
     * @return the pe map
     */
    public Map<String, List<IntContainerPe>> getPeMap() {
        return peMap;
    }
     ...
     */
    protected void setPeMap(Map<String, List<IntContainerPe>> peMap) {
        this.peMap = peMap;
    }
