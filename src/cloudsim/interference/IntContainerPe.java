...
public class IntContainerPe {
     ...
     * The pe provisioner.
     */
    private IntContainerPeProvisioner containerPeProvisioner;
     ...
     * @post $none
     */
    public IntContainerPe(int id, IntContainerPeProvisioner containerPeProvisioner) {
        setId(id);
    ...
    public IntContainerPeProvisioner getContainerPeProvisioner() {
     ...
     */
    public void setContainerPeProvisioner(IntContainerPeProvisioner containerPeProvisioner) {
